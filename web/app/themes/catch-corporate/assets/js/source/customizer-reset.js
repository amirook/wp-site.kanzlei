jQuery(function(s) {
    var e = [
        ["#customize-theme-controls", "all", "ct-reset", "ct-reset-main", catchCorporateCustomizerReset.confirm, catchCorporateCustomizerReset.reset],
    ];
    s.each(e, function(e, o) {
        ...
        c.on("click", function(e) {
            ...
            var t = {
                ...
                nonce: catchCorporateCustomizerReset.nonce.reset,
                section: o[1]
            };
