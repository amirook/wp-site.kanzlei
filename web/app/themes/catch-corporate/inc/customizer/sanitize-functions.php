<?php
/**
 * Catch Corporate Theme Options Sanitization Functions
 *
 ...
 * @since 1.0.0
 */
function catch_corporate_sanitize_project_type( $input ) {
    if ( '' != $input ) {
        if ( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 */
function catch_corporate_sanitize_select( $input, $setting ) {
 ...
 */
function catch_corporate_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function catch_corporate_sanitize_post( $input ) {
 ...
 */
function catch_corporate_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since 1.0.0
 */
function catch_corporate_sanitize_category_list( $input ) {
...
/**
 * Sanitizes product category list in slider
 * @param  $input entered value
 * @return sanitized output
 *
 * @since 1.0.0
 */
function catch_corporate_sanitize_product_category_list( $input ) {
    if ( is_array( $input ) && '' != $input ) {
        if ( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function catch_corporate_sanitize_number_range( $number, $setting ) {
